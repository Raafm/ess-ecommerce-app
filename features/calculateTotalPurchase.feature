Feature: estatisticas dos cancelados
Como um usuário admin
Eu quero ser capaz de ver os dados sobre os pedidos cancelados ao longo do tempo e quero ser capaz de filtra-los pelo tempo.
Para que eu possa ver estatísticas relacionadas às compras que foram canceladas

Feature: estatísticas de vendas por pessoa
Como um usuário admin
...
Para que eu possa ver os periodos em que ocorrem mais/menos vendas
