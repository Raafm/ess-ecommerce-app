Feature: Estatísticas
    ...
    Scenario: Ver estatística por pedido
        ...
        When  O usuário clica a aba de dados por pedido (ID 130)
    ...
    Scenario: Ver estatística dos cancelados
        ...
        When  O usuário clica a aba de dados para pedidos cancelados (ID 131)
    ...
    Scenario: Selecionar período
        ...
        And O usuário clica a aba de dados por pedido (ID 132)
